...
import { db, auth } from '../FirebaseConfigs/firebase';
  ...
  return (
    <div className='cart-prod-container'>
            <div className='cart-prod-imgtitle'>
                <div className='prod-image'><img src={props.itemdata.product.productimage} alt="ac" /></div>
